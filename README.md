...
FetchContent_Declare(CppMu GIT_REPOSITORY https://github.com/thetic/cppmu.git GIT_TAG main)
...
| `CPPMU_PTR_SET` — automatic pointer restore | [docs/set-pointer-plugin.md](docs/set-pointer-plugin.md) |
