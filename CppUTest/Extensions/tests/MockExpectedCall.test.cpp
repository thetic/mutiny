...
TEST_GROUP(MockExpectedCall)
{
  ...
  void setup() override
  {
    original_comparator_repository = cpputest::extensions::MockNamedValue::
...
{
  cpputest::extensions::MockCheckedExpectedCall expected_call(1);
...
{
  cpputest::extensions::MockCheckedExpectedCall expected_call(2);
  expected_call.with_name("name");
  CHECK(!expected_call.is_fulfilled());
  CHECK(expected_call.can_match_actual_calls());
}
...
{
  cpputest::extensions::MockCheckedExpectedCall expected_call(3);
  expected_call.with_name("name");
  expected_call.call_was_made(1);
...
{
  cpputest::extensions::MockCheckedExpectedCall expected_call(5);
  expected_call.with_name("name");
...
{
  cpputest::extensions::MockCheckedExpectedCall expected_call(4);
  expected_call.with_name("name");
