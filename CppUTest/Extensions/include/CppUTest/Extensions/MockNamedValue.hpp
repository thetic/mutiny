#ifndef INCLUDED_CPPUTEST_EXTENSIONS_MOCKNAMEDVALUE_HPP
#define INCLUDED_CPPUTEST_EXTENSIONS_MOCKNAMEDVALUE_HPP
...
public:
  ...
  virtual void set_const_object_pointer(const cpputest::String& type,
      const void* object_ptr);
  virtual void set_object_pointer(const cpputest::String& type,
      void* object_ptr);
  ...
  virtual cpputest::String to_string() const;

  virtual cpputest::String get_name() const;
  virtual cpputest::String get_type() const;
