#ifndef INCLUDED_MUTINY_MOCKSUPPORT_H
#define INCLUDED_MUTINY_MOCKSUPPORT_H
 ...
 * Call mutiny_mock() to get the global mock scope, or mutiny_mock_scope() for a
...
extern "C"
{
  ...
  /**
   * @brief Discriminator for the type stored in a MutinyMockValue.
   *
   * Each enumerator corresponds to one field of the MutinyMockValue union.
   */
   ...
   * MutinyMockSupport. Chain the @c with_*_parameters function pointers to
   * supply parameter values, then call a return-value accessor.
   *
   * @see MutinyMockSupport::actual_call
   */
   ...
   *
   * Obtained by calling mutiny_mock() or mutiny_mock_scope(). Use the function
   ...
   *
   * @return Pointer to the MutinyMockSupport vtable for the global scope.
   *
   ...
   * @return Pointer to the MutinyMockSupport vtable for the named scope.
   *
   * @see mutiny_mock()
   */
