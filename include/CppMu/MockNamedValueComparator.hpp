#ifndef INCLUDED_CPPMU_MOCKNAMEDVALUECOMPARATOR_HPP
#define INCLUDED_CPPMU_MOCKNAMEDVALUECOMPARATOR_HPP
 ...
 * cppmu::String point_to_string(const void* p) { ... }
 *
 ...
 *
 * @code
 * cppmu::TypedMockComparator<Point> cmp;
 * mock().install_comparator("Point", cmp);
 * @endcode
 */
template<typename T>
