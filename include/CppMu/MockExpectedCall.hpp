#ifndef INCLUDED_CPPMU_MOCKEXPECTEDCALL_HPP
#define INCLUDED_CPPMU_MOCKEXPECTEDCALL_HPP
...
public:
   ...
   * @return *this for chaining.
   */
  MockExpectedCall& with_parameter(const cppmu::String& name, bool value)
  {
    return with_bool_parameter(name, value);
  }
  /** @copydoc with_parameter(const cppmu::String&, bool) */
  MockExpectedCall& with_parameter(const cppmu::String& name, int value)
  {
  ...
  /** @copydoc with_parameter(const cppmu::String&, bool) */
  MockExpectedCall& with_parameter(const cppmu::String& name, long int value)
  {
  ...
  /** @copydoc with_parameter(const cppmu::String&, bool) */
  MockExpectedCall& with_parameter(const cppmu::String& name, long long value)
  {
  ...
  /** @copydoc with_parameter(const cppmu::String&, bool) */
  MockExpectedCall& with_parameter(const cppmu::String& name, double value)
  {
  ...
  /** @copydoc with_parameter(const cppmu::String&, bool) */
  MockExpectedCall& with_parameter(const cppmu::String& name, const char* value)
  {
    return with_string_parameter(name, value);
  }
  /** @copydoc with_parameter(const cppmu::String&, bool) */
  MockExpectedCall& with_parameter(const cppmu::String& name, void* value)
  {
    return with_pointer_parameter(name, value);
  }
  /** @copydoc with_parameter(const cppmu::String&, bool) */
  MockExpectedCall& with_parameter(const cppmu::String& name, const void* value)
  {
