...
/**
 * @file CppMu.hpp
 * @brief Primary test-definition header for CppMu.
 *
 ...
 *
 * Creates a struct that derives from cppmu::Test. Use with
 ...
 * @ref TEST_GROUP which uses cppmu::Test directly.
 *
 * @param testGroup  Identifier for the group (used in filtering and output).
 * @param baseclass  Base class that must derive from cppmu::Test.
 *
...
/**
 * @brief Define a named test group using cppmu::Test as the base class.
 *
 * All tests in the group share the same setup() and teardown() methods.
 ...
 * definition uses TEST() from CppMu.h in the .c file.
 *
