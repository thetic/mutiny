...
/**
 * @file MockSupport.h
 * @brief C interface to the CppMu mock framework.
 *
 * Provides a vtable-style C API for mock interaction from pure C test code.
 * Call cppmu_mock() to get the global mock scope, or cppmu_mock_scope() for a
 ...
 *   return cppmu_mock()->actual_call("open_port")
 ...
 * {
 *   cppmu_mock()->expect_one_call("open_port")->with_int_parameters("port",
 * 80); connect_to_server(); cppmu_mock()->check_expectations();
 *   cppmu_mock()->clear();
 * }
 * @endcode
 *
 * @see cppmu_mock(), cppmu_mock_scope()
 */
...
extern "C"
{
  ...
  /**
   * @brief Discriminator for the type stored in a CppMuMockValue.
   *
   * Each enumerator corresponds to one field of the CppMuMockValue union.
   */
  enum CppMuMockValueType
  {
    cppmu_type_bool,                       /**< Boolean (stored as int). */
    cppmu_type_unsigned_integer,           /**< unsigned int */
    cppmu_type_integer,                    /**< int */
    cppmu_type_long_integer,               /**< long int */
    cppmu_type_unsigned_long_integer,      /**< unsigned long int */
    cppmu_type_long_long_integer,          /**< long long */
    cppmu_type_unsigned_long_long_integer, /**< unsigned long long */
    cppmu_type_double,                     /**< double */
    cppmu_type_string,                     /**< const char* */
    cppmu_type_pointer,                    /**< void* */
    cppmu_type_const_pointer,              /**< const void* */
    cppmu_type_functionpointer,            /**< void (*)(void) */
    cppmu_type_memorybuffer,               /**< const unsigned char* */
    cppmu_type_object,                     /**< void* (custom object) */
    cppmu_type_const_object /**< const void* (const custom object) */
  };
   ...
   *
   * Obtained by calling the @c actual_call function pointer on a
   * CppMuMockSupport. Chain the @c with_*_parameters function pointers to
   * supply parameter values, then call a return-value accessor.
   *
   * @see CppMuMockSupport::actual_call
   */
  struct CppMuMockActualCall
  {
    /** @brief Report a bool parameter. @param name Parameter name. @param value
     * Value (non-zero = true). @return this. */
    struct CppMuMockActualCall* (*with_bool_parameters)(
        const char* name,
        int value
    );
    /** @brief Report an int parameter. @param name Parameter name. @param value
     * Value. @return this. */
    struct CppMuMockActualCall* (*with_int_parameters)(
        const char* name,
        int value
    );
    /** @brief Report an unsigned int parameter. @param name Parameter name.
     * @param value Value. @return this. */
    struct CppMuMockActualCall* (*with_unsigned_int_parameters)(
        const char* name,
        unsigned int value
    );
    /** @brief Report a long int parameter. @param name Parameter name. @param
     * value Value. @return this. */
    struct CppMuMockActualCall* (*with_long_int_parameters)(
        const char* name,
        long int value
    );
    /** @brief Report an unsigned long int parameter. @param name Parameter
     * name. @param value Value. @return this. */
    struct CppMuMockActualCall* (*with_unsigned_long_int_parameters)(
        const char* name,
        unsigned long int value
    );
    /** @brief Report a long long parameter. @param name Parameter name. @param
     * value Value. @return this. */
    struct CppMuMockActualCall* (*with_long_long_int_parameters)(
        const char* name,
        long long value
    );
    /** @brief Report an unsigned long long parameter. @param name Parameter
     * name. @param value Value. @return this. */
    struct CppMuMockActualCall* (*with_unsigned_long_long_int_parameters)(
        const char* name,
        unsigned long long value
    );
    /** @brief Report a double parameter. @param name Parameter name. @param
     * value Value. @return this. */
    struct CppMuMockActualCall* (*with_double_parameters)(
        const char* name,
        double value
    );
    /** @brief Report a string parameter. @param name Parameter name. @param
     * value Value. @return this. */
    struct CppMuMockActualCall* (*with_string_parameters)(
        const char* name,
        const char* value
    );
    /** @brief Report a void* parameter. @param name Parameter name. @param
     * value Value. @return this. */
    struct CppMuMockActualCall* (*with_pointer_parameters)(
        const char* name,
        void* value
    );
    /** @brief Report a const void* parameter. @param name Parameter name.
     * @param value Value. @return this. */
    struct CppMuMockActualCall* (*with_const_pointer_parameters)(
        const char* name,
        const void* value
    );
    /** @brief Report a function pointer parameter. @param name Parameter name.
     * @param value Value. @return this. */
    struct CppMuMockActualCall* (*with_function_pointer_parameters)(
        const char* name,
        void (*value)(void)
    );
    /** @brief Report a memory buffer parameter. @param name Parameter name.
    ...
    /** @brief Report an object parameter identified by type name. @param type
     * Type name. @param name Parameter name. @param value Object pointer.
     * @return this. */
    ...
    /** @brief Report an output parameter. @param name Parameter name. @param
     * value Output buffer. @return this. */
    struct CppMuMockActualCall* (*with_output_parameter)(
        const char* name,
        void* value
    );
    /** @brief Report a custom-type output parameter. @param type Type name.
     * @param name Parameter name. @param value Output buffer. @return this. */
    ...
    /** @return The bool return value if set, otherwise @p default_value. @param
     * default_value Fallback. */
    int (*return_bool_value_or_default)(int default_value);
    /** @return The configured int return value. */
    int (*int_return_value)(void);
    /** @return The int return value if set, otherwise @p default_value. @param
     * default_value Fallback. */
    ...
    /** @return The unsigned int return value if set, otherwise @p
     * default_value. @param default_value Fallback. */
   ...
   *
   * Obtained from CppMuMockSupport::expect_one_call() or similar. Chain the
  ...
  {
    /** @brief Constrain a bool parameter. @param name Name. @param value Value.
     * @return this. */
    struct CppMuMockExpectedCall* (*with_bool_parameters)(
        const char* name,
        int value
    );
    /** @brief Constrain an int parameter. @param name Name. @param value Value.
     * @return this. */
    struct CppMuMockExpectedCall* (*with_int_parameters)(
        const char* name,
        int value
    );
    /** @brief Constrain an unsigned int parameter. @param name Name. @param
     * value Value. @return this. */
    struct CppMuMockExpectedCall* (*with_unsigned_int_parameters)(
        const char* name,
        unsigned int value
    );
    /** @brief Constrain a long int parameter. @param name Name. @param value
     * Value. @return this. */
    struct CppMuMockExpectedCall* (*with_long_int_parameters)(
        const char* name,
        long int value
    );
    /** @brief Constrain an unsigned long int parameter. @param name Name.
     * @param value Value. @return this. */
    struct CppMuMockExpectedCall* (*with_unsigned_long_int_parameters)(
        const char* name,
        unsigned long int value
    );
    /** @brief Constrain a long long parameter. @param name Name. @param value
     * Value. @return this. */
    struct CppMuMockExpectedCall* (*with_long_long_int_parameters)(
        const char* name,
        long long value
    );
    /** @brief Constrain an unsigned long long parameter. @param name Name.
     * @param value Value. @return this. */
    struct CppMuMockExpectedCall* (*with_unsigned_long_long_int_parameters)(
        const char* name,
        unsigned long long value
    );
    /** @brief Constrain a double parameter (exact). @param name Name. @param
     * value Value. @return this. */
    struct CppMuMockExpectedCall* (*with_double_parameters)(
        const char* name,
        double value
    );
    /** @brief Constrain a double parameter with tolerance. @param name Name.
     * @param value Value. @param tolerance Max difference. @return this. */
    struct CppMuMockExpectedCall* (*with_double_parameters_and_tolerance)(
        const char* name,
        double value,
        double tolerance
    );
    /** @brief Constrain a string parameter. @param name Name. @param value
     * Value. @return this. */
    struct CppMuMockExpectedCall* (*with_string_parameters)(
        const char* name,
        const char* value
    );
    /** @brief Constrain a void* parameter. @param name Name. @param value
     * Value. @return this. */
    struct CppMuMockExpectedCall* (*with_pointer_parameters)(
        const char* name,
        void* value
    );
    /** @brief Constrain a const void* parameter. @param name Name. @param value
     * Value. @return this. */
    struct CppMuMockExpectedCall* (*with_const_pointer_parameters)(
        const char* name,
        const void* value
    );
    /** @brief Constrain a function pointer parameter. @param name Name. @param
     * value Value. @return this. */
    struct CppMuMockExpectedCall* (*with_function_pointer_parameters)(
        const char* name,
        void (*value)(void)
    );
    /** @brief Constrain a memory buffer parameter. @param name Name. @param
     * value Buffer. @param size Size. @return this. */
    struct CppMuMockExpectedCall* (*with_memory_buffer_parameter)(
        const char* name,
        const unsigned char* value,
        size_t size
    );
    /** @brief Constrain a custom-type object parameter. @param type Type name.
     * @param name Name. @param value Object pointer. @return this. */
    struct CppMuMockExpectedCall* (*with_parameter_of_type)(
        const char* type,
        const char* name,
        const void* value
    );
    /** @brief Configure an output parameter (plain memcpy). @param name Name.
     * @param value Source data. @param size Bytes to copy. @return this. */
    struct CppMuMockExpectedCall* (*with_output_parameter_returning)(
        const char* name,
        const void* value,
        size_t size
    );
    /** @brief Configure a custom-type output parameter. @param type Type name.
     * @param name Name. @param value Source object. @return this. */
     ...
     * unchanged. @param name Name. @return this. */
    struct CppMuMockExpectedCall* (*with_unmodified_output_parameter)(
        const char* name
    );
    /** @brief Allow the actual call to pass extra unlisted parameters. @return
     * this. */
    struct CppMuMockExpectedCall* (*ignore_other_parameters)(void);

    /** @brief Configure a bool return value. @param value Value to return.
     * @return this. */
    struct CppMuMockExpectedCall* (*and_return_bool_value)(int value);
    /** @brief Configure an unsigned int return value. @param value Value.
     * @return this. */
    struct CppMuMockExpectedCall* (*and_return_unsigned_int_value)(
        unsigned int value
    );
    /** @brief Configure an int return value. @param value Value. @return this.
     */
    struct CppMuMockExpectedCall* (*and_return_int_value)(int value);
    /** @brief Configure a long int return value. @param value Value. @return
     * this. */
    struct CppMuMockExpectedCall* (*and_return_long_int_value)(long int value);
    /** @brief Configure an unsigned long int return value. @param value Value.
     * @return this. */
    struct CppMuMockExpectedCall* (*and_return_unsigned_long_int_value)(
        unsigned long int value
    );
    /** @brief Configure a long long return value. @param value Value. @return
     * this. */
    struct CppMuMockExpectedCall* (*and_return_long_long_int_value)(
        long long value
    );
    /** @brief Configure an unsigned long long return value. @param value Value.
     * @return this. */
    struct CppMuMockExpectedCall* (*and_return_unsigned_long_long_int_value)(
        unsigned long long value
    );
    /** @brief Configure a double return value. @param value Value. @return
     * this. */
    struct CppMuMockExpectedCall* (*and_return_double_value)(double value);
    /** @brief Configure a string return value. @param value Value. @return
     * this. */
    struct CppMuMockExpectedCall* (*and_return_string_value)(const char* value);
    /** @brief Configure a void* return value. @param value Value. @return this.
     */
    struct CppMuMockExpectedCall* (*and_return_pointer_value)(void* value);
    /** @brief Configure a const void* return value. @param value Value. @return
     * this. */
    struct CppMuMockExpectedCall* (*and_return_const_pointer_value)(
        const void* value
    );
    /** @brief Configure a function pointer return value. @param value Value.
     * @return this. */
   ...
   *
   * Obtained by calling cppmu_mock() or cppmu_mock_scope(). Use the function
   * pointers to set up expectations, report actual calls, install comparators,
   * and verify/clear state.
   *
   * @see cppmu_mock(), cppmu_mock_scope()
   */
  struct CppMuMockSupport
  {
    ...
    /** @brief Expect exactly one call. @param name Function name. @return
     * Expected-call vtable. */
    struct CppMuMockExpectedCall* (*expect_one_call)(const char* name);
    /** @brief Assert function is never called. @param name Function name. */
    void (*expect_no_call)(const char* name);
    /** @brief Expect exactly @p number calls. @param number Count. @param name
     * Function name. @return Expected-call vtable. */
    struct CppMuMockExpectedCall* (*expect_n_calls)(
        unsigned int number,
        const char* name
    );
    /** @brief Report an actual call from a mock implementation. @param name
     * Function name. @return Actual-call vtable. */
    ...
    /** @return The configured bool return value (as int). */
    int (*bool_return_value)(void);
    /** @return Bool return value or @p default_value. @param default_value
     * Fallback. */
    int (*return_bool_value_or_default)(int default_value);
    /** @return The configured int return value. */
    int (*int_return_value)(void);
    /** @return Int return value or @p default_value. @param default_value
     * Fallback. */
    int (*return_int_value_or_default)(int default_value);
    /** @return The configured unsigned int return value. */
    unsigned int (*unsigned_int_return_value)(void);
    /** @return Unsigned int return value or @p default_value. @param
     * default_value Fallback. */
    unsigned int (*return_unsigned_int_value_or_default)(
        unsigned int default_value
    );
    /** @return The configured long int return value. */
    long int (*long_int_return_value)(void);
    /** @return Long int return value or @p default_value. @param default_value
     * Fallback. */
    long int (*return_long_int_value_or_default)(long int default_value);
    /** @return The configured unsigned long int return value. */
    unsigned long int (*unsigned_long_int_return_value)(void);
    /** @return Unsigned long int return value or @p default_value. @param
     * default_value Fallback. */
    unsigned long int (*return_unsigned_long_int_value_or_default)(
        unsigned long int default_value
    );
    /** @return The configured long long return value. */
    long long (*long_long_int_return_value)(void);
    /** @return Long long return value or @p default_value. @param default_value
     * Fallback. */
    long long (*return_long_long_int_value_or_default)(long long default_value);
    /** @return The configured unsigned long long return value. */
    unsigned long long (*unsigned_long_long_int_return_value)(void);
    /** @return Unsigned long long return value or @p default_value. @param
     * default_value Fallback. */
    unsigned long long (*return_unsigned_long_long_int_value_or_default)(
        unsigned long long default_value
    );
    /** @return The configured C string return value. */
    const char* (*string_return_value)(void);
    /** @return String return value or @p default_value. @param default_value
     * Fallback. */
    const char* (*return_string_value_or_default)(const char* default_value);
    /** @return The configured double return value. */
    double (*double_return_value)(void);
    /** @return Double return value or @p default_value. @param default_value
     * Fallback. */
    double (*return_double_value_or_default)(double default_value);
    /** @return The configured void* return value. */
    void* (*pointer_return_value)(void);
    /** @return Pointer return value or @p default_value. @param default_value
     * Fallback. */
    void* (*return_pointer_value_or_default)(void* default_value);
    /** @return The configured const void* return value. */
    const void* (*const_pointer_return_value)(void);
    /** @return Const pointer return value or @p default_value. @param
     * default_value Fallback. */
    const void* (*return_const_pointer_value_or_default)(
        const void* default_value
    );
    /** @return The configured function pointer return value. */
    void (*(*function_pointer_return_value)(void))(void);
    /** @return Function pointer return value or @p default_value. @param
     * default_value Fallback. */
    void (*(*return_function_pointer_value_or_default)(void (*default_value)(
        void
    )))(void);

    /** @brief Store a bool data value. @param name Key. @param value Value. */
    void (*set_bool_data)(const char* name, int value);
    /** @brief Store an int data value. @param name Key. @param value Value. */
    void (*set_int_data)(const char* name, int value);
    /** @brief Store an unsigned int data value. @param name Key. @param value
     * Value. */
    void (*set_unsigned_int_data)(const char* name, unsigned int value);
    /** @brief Store a long int data value. @param name Key. @param value Value.
     */
    void (*set_long_int_data)(const char* name, long int value);
    /** @brief Store an unsigned long int data value. @param name Key. @param
     * value Value. */
    void (*set_unsigned_long_int_data)(
        const char* name,
        unsigned long int value
    );
    /** @brief Store a string data value. @param name Key. @param value Value.
     */
    void (*set_string_data)(const char* name, const char* value);
    /** @brief Store a double data value. @param name Key. @param value Value.
     */
    void (*set_double_data)(const char* name, double value);
    /** @brief Store a void* data value. @param name Key. @param value Value. */
    void (*set_pointer_data)(const char* name, void* value);
    /** @brief Store a const void* data value. @param name Key. @param value
     * Value. */
    void (*set_const_pointer_data)(const char* name, const void* value);
    /** @brief Store a function pointer data value. @param name Key. @param
     * value Value. */
    void (*set_function_pointer_data)(const char* name, void (*value)(void));
    /** @brief Store a mutable object pointer with type name. @param name Key.
     * @param type Type name. @param value Object pointer. */
    void (*set_data_object)(const char* name, const char* type, void* value);
    /** @brief Store a const object pointer with type name. @param name Key.
     * @param type Type name. @param value Object pointer. */
    ...
    /** @return Previously stored data value. @param name Key. */
    struct CppMuMockValue (*get_data)(const char* name);

    /** @brief Disable this scope; actual_call() becomes a no-op. */
    void (*disable)(void);
     ...
     *
     * All actual_call() invocations are silently accepted without matching
     * an expectation.
     */
   ...
   *
   * @return Pointer to the CppMuMockSupport vtable for the global scope.
   *
   * @see cppmu_mock_scope()
   */
   ...
   * @return Pointer to the CppMuMockSupport vtable for the named scope.
   *
   * @see cppmu_mock()
   */
