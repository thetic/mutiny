/**
 * @file CppMu.h
 * @brief C interface for writing CppMu tests in pure C.
 *
 ...
 * @endcode
 *
 * @see CppMu.hpp for the C++ interface
 * @see TEST_GROUP_C_WRAPPER and friends in CppMu.hpp for the .cpp bridge
 */
