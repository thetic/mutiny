...
void MockNamedValueComparatorsAndCopiersRepository::install_comparator(
    const String& name,
    MockNamedValueComparator& comparator
)
{
...
void MockNamedValueComparatorsAndCopiersRepository::install_copier(
    const String& name,
    MockNamedValueCopier& copier
)
{
...
MockNamedValueComparator* MockNamedValueComparatorsAndCopiersRepository::
...
MockNamedValueCopier* MockNamedValueComparatorsAndCopiersRepository::
...
void MockNamedValueComparatorsAndCopiersRepository::
    install_comparators_and_copiers(
