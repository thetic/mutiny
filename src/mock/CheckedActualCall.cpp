...
ActualCall& CheckedActualCall::with_bool_parameter(
    const String& name,
    bool value
)
{
...
ActualCall& CheckedActualCall::with_unsigned_int_parameter(
    const String& name,
    unsigned int value
)
{
...
ActualCall& CheckedActualCall::with_int_parameter(const String& name, int value)
{
  NamedValue actual_parameter(name);
  actual_parameter.set_value(value);
  check_input_parameter(static_cast<NamedValue&&>(actual_parameter));
...
ActualCall& CheckedActualCall::with_unsigned_long_int_parameter(
    const String& name,
...
ActualCall& CheckedActualCall::with_long_int_parameter(
    const String& name,
    long int value
)
{
...
ActualCall& CheckedActualCall::with_unsigned_long_long_int_parameter(
    const String& name,
...
ActualCall& CheckedActualCall::with_long_long_int_parameter(
    const String& name,
    long long value
)
{
...
ActualCall& CheckedActualCall::with_double_parameter(
    const String& name,
    double value
)
{
...
ActualCall& CheckedActualCall::with_string_parameter(
    const String& name,
    const char* value
)
{
...
ActualCall& CheckedActualCall::with_pointer_parameter(
    const String& name,
    void* value
)
{
...
ActualCall& CheckedActualCall::with_const_pointer_parameter(
    const String& name,
    const void* value
)
{
...
ActualCall& CheckedActualCall::with_function_pointer_parameter(
    const String& name,
    void (*value)()
)
{
...
ActualCall& CheckedActualCall::with_memory_buffer_parameter(
    const String& name,
...
bool CheckedActualCall::return_bool_value_or_default(bool default_value)
{
  if (!has_return_value()) {
...
const char* CheckedActualCall::return_string_value_or_default(
