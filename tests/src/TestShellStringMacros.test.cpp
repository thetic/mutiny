...
SKIPPED_TEST(TestShellStringMacros, STRCMP_EQUALWorksInAnSkippedTest)
{
...
SKIPPED_TEST(TestShellStringMacros, STRCMP_EQUAL_TEXTWorksInAnSkippedTest)
{
...
SKIPPED_TEST(TestShellStringMacros, STRNCMP_EQUALWorksInAnSkippedTest)
{
...
SKIPPED_TEST(TestShellStringMacros, STRNCMP_EQUAL_TEXTWorksInAnSkippedTest)
{
...
SKIPPED_TEST(TestShellStringMacros, STRCMP_CONTAINSWorksInAnSkippedTest)
{
  STRCMP_CONTAINS("Hello", "World");
}
...
SKIPPED_TEST(TestShellStringMacros, STRCMP_CONTAINS_TEXTWorksInAnSkippedTest)
{
  STRCMP_CONTAINS_TEXT("Hello", "World", "Failed because it failed");
}
