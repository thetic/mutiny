...
TEST(IgnoredExpectedCall, worksAsItShould)
{
  ...
  ignored.with_parameter("bla", 1);
  ignored.with_parameter("foo", 1U);
  ignored.with_parameter("hey", 1L);
  ignored.with_parameter("bah", 1UL);
  ignored.with_parameter("yo", 1LL);
  ignored.with_parameter("grr", 1ULL);
  ignored.with_parameter("hah", 1.1);
