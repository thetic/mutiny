...
TEST(MockSupport_c, whenNoReturnValueIsGivenReturnUnsignedIntValueOrDefaultShouldlUseTheDefaultValue)
{
  ...
  LONGS_EQUAL(
      default_value, mock()->return_unsigned_int_value_or_default(default_value)
  );
}
...
TEST(MockSupport_c, whenReturnValueIsGivenReturnStringValueOrDefaultShouldIgnoreTheDefault)
{
  ...
  STRCMP_EQUAL(
      expected_value,
      mock()->actual_call("foo")->return_string_value_or_default(default_value)
  );
  STRCMP_EQUAL(
...
TEST(MockSupport_c, whenReturnValueIsGivenReturnPointerValueOrDefaultShouldIgnoreTheDefault)
{
  ...
  POINTERS_EQUAL(
      expected_value,
      mock()->actual_call("foo")->return_pointer_value_or_default(default_value)
  );
  POINTERS_EQUAL(
...
TEST(MockSupport_c, MockSupportSetUnsignedLongIntData)
{
  ...
  UNSIGNED_LONGS_EQUAL(
      i, mock()->get_data("unsigned long integer").value.unsigned_long_int_value
  );
}
